...
public class StructuredObject implements PseudoColumnNames, Comparable<StructuredObject> {
    ...
    public StructuredObject source(Enum<?> key, Object value) {
    	source.put(key.toString(), value);
    	return this;
    }    
    
    public StructuredObject source(String key, Object value) {
    ...
    /**
     * Method to build XContent from a map of JSON
     *
     * @param builder the builder
     * @param map     the map
     * @throws IOException
     */
    protected void build(XContentBuilder builder, Map<String,Object> data) throws IOException {        
        builder.startObject();
    	if (null != data) {
    ...
    public boolean isEmpty() {
        return index() == null && type() == null && id() == null && null == meta;
    }
